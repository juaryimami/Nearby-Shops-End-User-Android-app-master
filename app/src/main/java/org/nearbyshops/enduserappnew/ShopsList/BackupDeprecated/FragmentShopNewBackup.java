...
import org.nearbyshops.enduserappnew.ShopsList.Interfaces.GetDataset;
...
public class FragmentShopNewBackup extends Fragment implements
...
//    @BindView(R.id.icon_list) ImageView mapIcon;
    ...
    public FragmentShopNewBackup() {
         ...
         * number.
         */
        public static FragmentShopNewBackup newInstance(boolean switchMade) {

            FragmentShopNewBackup fragment = new FragmentShopNewBackup();
    ...
    void setupRecyclerView()
        {
            ...
            adapter = new AdapterShopTwoBackup(dataset,getActivity(),this);
